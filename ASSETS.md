...
- **Web Delivery (`public/assets/images/`)**: All site image references use optimized WebP format (quality ~82) plus the vector/transparent PNG logo, reducing total deployed image weight from **10.85 MB to 2.75 MB** (a **74.7% reduction**).
...
| `home-hero-background` | `real` | `.webp` | `.png` (1.5MB) | GoDaddy Original Upload | `src/pages/index.tsx:75` | High |
