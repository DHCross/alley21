...
export default function RootLayout({ children }: RootLayoutProps) {
  return (
    <Website>
      <Helmet>
        <title>Alley 21 Enterprises</title>
        <meta name="description" content="Alley 21 Enterprises — AI consulting, creative furniture solutions, curated vintage collections, and personal development tools." />
      </Helmet>
      <ScrollRestoration />
      <Header />
      {children}
