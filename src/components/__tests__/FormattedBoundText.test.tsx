...
describe('FormattedBoundText', () => {
  ...
  it('wraps children and applies matching override marks', () => {
    ...
    const formatted = container.querySelector('[data-airo-formatted-bound-text]')
  ...
  it('updates rendered marks when the format override bundle changes', () => {
    ...
    expect(container.querySelector('[data-airo-formatted-bound-text]')).not.toBeInTheDocument()
